...
if(isset($_GET["p_id"])){
  ...
  if(isset($_POST["update_post"])){
	...
	while($row = mysqli_fetch_assoc($query_select_image)){
      ...
      //crud_alert("frissítése", "posts.php");
      
      echo "<p class='bg-success'>A poszt frissítése sikeresen megtörtént. <a href='../post.php?p_id={$post_id}'> Ugrás a poszthoz</a> vagy <a href='posts.php'> Vissza a posztok szerkesztéshez</a></p>";
  }
  ...
  <div class="form-group">
	<select name="post_status" id="post_status">
	  <option value="<?php echo $post_status ?>"><?php echo $post_status; ?></option>
	    ...
	    if($post_status == "publikálva"){
	    
	      echo "<option value='piszkozat'>piszkozat</option>";
	      
	    } else {
	    
	      echo "<option value='publikálva'>publikálva</option>";
...
<div class="form-group">
  ...
  <div class="form-group">
	 <label for="post_tags">Tegek</label>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
	  <input class="btn btn-primary" type="submit" name="update_post" value="Frissítés">
  </div>
